...
class Vista_previa_solicitud extends CI_Controller {
    ...
    private function load()
    {
        ...
        $html = '';
            ...
            $html .= '<div class="title_refacciones"><b>SOLICITUD DE REFACCIONES</b></div>';
                ...
                $html .= '<table id="printSolicitud">';
                    ...
                    $html .= '<tbody>';
                        ...
                        $html .= '</tr>';
                         ...
                         $html .= '<tr>';
                            $html .= '<td class="titlePrintVale" colspan="2"><center><b>No. ECNONOMICO</b></center></td>';
                            $html .= '<td class="titlePrintVale" colspan="2"><center><b>REFACCIONARIA</b></center></td>';
                            $html .= '<td class="titlePrintVale" colspan="2"><center><b>ESTATUS</b></center></td>';
                        $html .= '</tr>';

                        $html .= '<tr>';
                            $html .= '<td class="contentPrintVale" colspan="2"><center>'.$econ.'</center></td>';
                            $html .= '<td class="contentPrintVale" colspan="2"><center>'.$refaccionaria.'</center></td>';
                            $html .= '<td class="contentPrintVale" colspan="2"><center>'.$estatus.'</center></td>';
                        $html .= '</tr>';

                        $html .= '<tr>';
                            $html .= '<td colspan="6"><center><b>DE LA MANERA MAS ATENTA SOLICITO A USTED LAS SIGUIENTES REFACCIONES:</b></center></td>';
                        $html .= '</tr>';
