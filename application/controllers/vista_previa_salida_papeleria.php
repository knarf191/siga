...
class Vista_previa_salida_papeleria extends CI_Controller {
            ...
            $html .= '<div >';
                $html .= '<table id="printOrden">';
                    ...
                    $html .= '<tbody>';
                        ...
                        $subtotal = 0;
                        $data_medicamentos = $query = $this->db->query("SELECT * FROM material_salida_papeleria WHERE id = '$folio' ");
                        foreach ($data_medicamentos->result_array() as $row)
                        {
                            $html .= '<tr>';
                                ...
                                $data_unidad = $query = $this->db->query("SELECT*FROM stock_papeleria WHERE descripcion = '$producto' ");
