...
class Stock_computo extends CI_Controller {
	...
	private function load()
	{
        ...
        $data = $this->consultas->getStockComputo();
		$html = '';

        $html .= '<div class="page-header" ><h1>Stock de artículos de cómputo</h1></div>'; 
            $html .= '<div class="span12">';

                 $html .= '<a href="'.base_url().'entradas_computo" class="btn btn-success" id="newVale"><i class="fa fa-upload"></i>&nbsp;Entrada</a>';
                 $html .= '<a href="'.base_url().'salidas_computo" class="btn btn-danger" id="newVale"><i class="fa fa-download"></i>&nbsp;Salida</a>';
