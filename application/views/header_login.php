...
<head>
    ...
    <title>SIGA - Sistema Infórmatico de Gestión Avanzada</title>
    ...
    <script src="<?php echo base_url();?>datatables/filter/range.js"></script>
</head>
    ...
    <nav class="nav navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <h3><b>SIGA | Sistema Infórmatico de Gestión Avanzada</b></h3>
            </div>
